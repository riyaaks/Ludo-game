...
root.title("Made by Lucky Riya Afrin")
...
def board():                            #Drawing the board, piece by piece.
                                        ...
                                        #Splash Screen.
    tkinter.messagebox.showinfo(title=None, message="TO START GAME PRESS OKAY! Lucky Riya Afrin")
    v = 0
    z = 0
...
def turn():   #Prints whoose turn is it
    ...
    if RED == True:
        L2 = Label(root, text="   Red's Turn    ", fg='Black', background='blue', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)
    ...
    if GREEN == True:
        L2 = Label(root, text="Green's Turn  ", fg='Black', background='blue', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)

    if YELLOW == True:
        L2 = Label(root, text="Yellow's Turn", fg='Black', background='blue', font=("Arial", 24, "bold"))
        L2.place(x=770, y=50)
...
button = Button(root, text="Click Here", relief="raised", font=("Arial", 15),
